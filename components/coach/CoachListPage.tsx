 ...
 * A reusable page component that displays a searchable and filterable list of coaches.
 * Each coach card includes a "Book Session" button, allowing any user to book a session.
 */
