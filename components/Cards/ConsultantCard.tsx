        ...
        <div className="space-y-1.5">
          {consultant.rating !== null && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm font-semibold text-gray-800">{consultant.rating}</span>
              {consultant.totalSessions !== null && (
                <span className="text-xs text-gray-400">({consultant.totalSessions} sessions)</span>
              )}
            </div>
          )}
          {consultant.yearsOfExperience !== null && (
