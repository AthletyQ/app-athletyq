...
//   // Get current logged-in consultant
//   useEffect(() => {
...
//   // Fetch conversations where consultant is the contact
//   useEffect(() => {
//     if (!currentUserId) return;

//     fetch(`/api/conversations?contactId=${currentUserId}`)
//       .then((r) => r.json())
...
//       .channel("consultant-conversations-updates")
//       .on(
//         "postgres_changes",
//         {
//           event: "UPDATE",
...
import ConsultantChatPageClient from './ConsultantChatPageClient'
