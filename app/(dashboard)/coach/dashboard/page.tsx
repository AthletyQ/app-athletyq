  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        // ✅ Step 2 — use their real user id
        const userId = user.id

        // ✅ Step 3 — fetch their coach profile
        const profileData = await getCoachProfile(userId)
        ...
        // ✅ Step 4 — fetch all dashboard data in parallel
