...
const CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      ...
      { id: 3, text: "Excellent! Let's focus on endurance today. I've prepared a new plan for you.", time: '10:33 AM', fromMe: false },
      { id: 4, text: "Sounds good! What's the target distance?", time: '10:35 AM', fromMe: true },
      { id: 5, text: "We'll aim for 10K at zone 2 pace. Take it easy and focus on form.", time: '10:36 AM', fromMe: false },
  ...
  },
  {
    ...
    initials: 'MC',
    name: 'Marcus Chen',
    preview: "I've updated your training plan. Ch...",
    time: '1h ago',
    role: 'Coach',
    roleColor: 'bg-blue-100 text-blue-600',
    online: true,
  ...
  },
  {
    ...
    preview: 'Your nutrition plan is ready fo...',
    time: '3h ago',
    role: 'Consultant',
            ...
            <div className="px-3 pt-4 pb-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-xs text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition"
                />
              </div>
            </div>
