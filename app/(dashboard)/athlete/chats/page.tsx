...
//   contact_unread_count: number  // consultant's unread
//   contact: Profile | null       // the consultant's profile
// }
...
//   const openWith      = searchParams.get('consultantId') // auto-open conversation
...
//   // ── Fetch conversations (athlete_id = me) ────────────────────────────────
...
//   // ── Auto-open conversation if consultantId param present ─────────────────
//   useEffect(() => {
//     if (!openWith || !currentUserId || conversations.length === 0) return
...
//   }, [openWith, currentUserId, conversations])
...
//   // ── Mark messages read (athlete side) ───────────────────────────────────
...
//     // Reset athlete's unread counter
//     await supabase
//       .from('conversations')
...
//             return [...prev, msg]
//           })
//           // Auto-mark read if the message came from the consultant
...
//     if (!error) {
//       // Update last_message + increment consultant's unread count
//       await supabase
//         .from('conversations')
//         .update({
...
//                 Visit the Consultants page to start a chat
//               </p>
//             </div>
//           ) : (
//             filtered.map((conv) => {
